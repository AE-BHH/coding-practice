...
// 4. Create and return new object whose keys are the elemetns of keyArr and whose values are the elements of valArr
...
// Match indexes, so the key set by keyArr[0] should have the value from valArr[0] etc.
// The arrays may be different lengths.
...
// Indexes should be inverse. Keys will be set from 0 to keyArr.length - 1. Values will set from keyArr.length - 1 to 0.
